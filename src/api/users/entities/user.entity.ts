import { AfterLoad, BeforeInsert, BeforeUpdate, Column, CreateDateColumn, Entity, Generated, JoinColumn, OneToOne, PrimaryGeneratedColumn, RelationId, UpdateDateColumn } from "typeorm";
...
export class User {
  ...
  @OneToOne(() => NotificationToken, notificationToken => notificationToken.user, { onDelete: "SET NULL" })
  @ApiPropertyOptional({})
